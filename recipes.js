...
rezepteSammlung = [
		{rezeptName: "Rucola Salat",
	     zutaten: [{menge: 0.5, einheit: "Packung", zutat: "Parmesan"},
	                {menge: 1, einheit: "Packung", zutat: "Rucula Salat"},
	                 {menge: 1, einheit: "", zutat: "Tomaten"}],
		...
		zutaten: [{menge: 1, einheit: "", zutat: "Gurke"},
	  				{menge: 4, einheit: "", zutat: "Tomaten"},
					{menge: 1, einheit: "Packung", zutat: "Schafskäse"},
					{menge: 12, einheit: "", zutat: "Oliven"},
	  				{menge: 1, einheit: "", zutat: "Zwiebel"}],
		...
		zutaten: [{menge: 1, einheit: "Packung", zutat: "Weichweizengrieß"},
					{menge: 500, einheit: "ml", zutat: "Milch"}],
		kommentar: "Umrühren nicht vergessen! 2,5 zu 1 Verhältnis Milch zu Gries. Zimt noch drüber streuen."
		},
		{rezeptName: "Pizza Seelen",
		zutaten: [{menge: 250, einheit: "g", zutat: "Reibekäse"},
					{menge: 250, einheit: "ml", zutat: "Süße Sahne"},
					{menge: 250, einheit: "g", zutat: "Schinken"},
					{menge: 0.25, einheit: "Tube", zutat: "Tomatenmark"},
					{menge: 3, einheit: "", zutat: "Seelen"}],
		...
		zutaten: [{menge: 1, einheit: "Packung", zutat: "Speckwürfel"},
					{menge: 4, einheit: "", zutat: "Eier"},
					{menge: 0.5, einheit: "Packung", zutat: "Parmesan"},
					{menge: 1, einheit: "Schachtel", zutat: "Schnittlauch"}],
		kommentar: "Geht auch als Mittag oder Abendessen. Gehaltvoll."
		},
		{rezeptName: "Bratkartoffeln",
		zutaten: [{menge: 5, einheit: "", zutat: "Kartoffeln"},
					{menge: 1, einheit: "", zutat: "Zwiebel"}],
		...
		zutaten: [{menge: 2000, einheit: "ml", zutat: "Milch"},
					{menge: 1, einheit: "Packung", zutat: "Köln Haferflocken (blau)"},
					{menge: 1, einheit: "Packung", zutat: "Ovomaltine"},
					{menge: 5, einheit: "", zutat: "Bananen"},
					{menge: 4, einheit: "", zutat: "Äpfel"},
					{menge: 1, einheit: "", zutat: "Sonstige Saisonfrüchte für Müsli"}],
		kommentar: "Tradition bewahren!"
		},
		{rezeptName: "Spaghetti Carbonara",
		zutaten: [{menge: 150, einheit: "g", zutat: "Speckwürfel"},
					{menge: 3, einheit: "", zutat: "Eier"},
					{menge: 100, einheit: "ml", zutat: "Süße Sahne"},
					{menge: 0.5, einheit: "Packung", zutat: "Parmesan"},
					{menge: 200, einheit: "g", zutat: "Spaghetti"},
					],
		...
		zutaten: [{menge: 3, einheit: "", zutat: "Eier"},
					{menge: 400, einheit: "g", zutat: "Mehl"},
					{menge: 400, einheit: "ml", zutat: "Milch"},
					{menge: 1, einheit: "Glas", zutat: "Apfelmus"},
					{menge: 1, einheit: "Glas", zutat: "Marmelade"},
					],
		...
		zutaten: [{menge: 500, einheit: "g", zutat: "Mehl"},
					{menge: 4, einheit: "", zutat: "Eier"},
					{menge: 3, einheit: "", zutat: "Zwiebel"},
					{menge: 300, einheit: "g", zutat: "Bergkäse"},
					],
		...
		zutaten: [{menge: 200, einheit: "g", zutat: "Bergkäse"},
					{menge: 200, einheit: "g", zutat: "Schinkenwurst"},
					{menge: 0.5, einheit: "Glas", zutat: "Essiggurke"},
					],
		...
		zutaten: [{menge: 8, einheit: "", zutat: "Kartoffeln"},
					{menge: 4, einheit: "", zutat: "Eier"},
					{menge: 1, einheit: "", zutat: "Zwiebel"},
					],
		...
		zutaten: [{menge: 250, einheit: "g", zutat: "Margarine"},
					{menge: 4, einheit: "", zutat: "Zitrone"},
					{menge: 150, einheit: "g", zutat: "Zucker"},
					{menge: 4, einheit: "", zutat: "Eier"},
					{menge: 300, einheit: "g", zutat: "Mehl"},
					{menge: 100, einheit: "g", zutat: "Speisestärke"},
					{menge: 1, einheit: "Packung", zutat: "Backpulver"},
					{menge: 50, einheit: "ml", zutat: "Milch"},
					{menge: 250, einheit: "g", zutat: "Puderzucker"},
					],
		...
		zutaten: [{menge: 375, einheit: "g", zutat: "Margarine"},
					{menge: 225, einheit: "g", zutat: "Zucker"},
					{menge: 540, einheit: "g", zutat: "Mehl"},
					{menge: 4, einheit: "", zutat: "Eier"},
					{menge: 190, einheit: "ml", zutat: "Milch"},
					//{menge: 150, einheit: "g", zutat: "Speisestärke"},
					{menge: 1.5, einheit: "Packung", zutat: "Backpulver"},
					{menge: 60, einheit: "g", zutat: "Kakaopulver"},
					],
		...
		zutaten: [{menge: 1, einheit: "Becher", zutat: "Sahne"},
					{menge: 1, einheit: "", zutat: "Eier"},
					{menge: 1, einheit: "", zutat: "Knoblauch"},
					{menge: 200, einheit: "g", zutat: "Mehl"},
					{menge: 100, einheit: "g", zutat: "Butter"},
					{menge: 1, einheit: "Packung", zutat: "Blattspinat"},
					{menge: 1, einheit: "Packung", zutat: "Lachs"},
					],
